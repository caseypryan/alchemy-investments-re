              ...
              <div className="bg-white rounded-lg shadow-xl mb-6 overflow-hidden border-4 border-white">
                {!formExpanded ? (
                  ...
                  <div className="p-8 text-center animate-in fade-in duration-300">
                    <div className="mb-4">
                      <svg className="w-16 h-16 text-[#22c55e] mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <form onSubmit={handleHeroFormSubmit} className="p-6 space-y-4 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div>
            ...
            {submitSuccess ? (
              <div className="max-w-2xl mx-auto mb-6 p-6 bg-white rounded-lg animate-in fade-in duration-300">
                <div className="text-center">
                  <svg className="w-12 h-12 text-[#22c55e] mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
